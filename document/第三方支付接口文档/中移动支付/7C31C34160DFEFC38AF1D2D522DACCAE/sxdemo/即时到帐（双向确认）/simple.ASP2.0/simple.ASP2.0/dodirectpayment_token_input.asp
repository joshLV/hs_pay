...
<head>
    ...
    <title>直接支付(双向确认)：DirectPayConfirm</title>
</head>
 <%
  Dim currDate
	currYear = Year(Date()) 
...
<html>
    <body>
        <form name = "form1" method = "post" action = "dodirectpayment_token.asp">
        	  <center>
            <p>
                <input type="hidden" name="merCert" value="" />
                <span class="title">直接支付(双向确认)：DirectPayConfirm</span>
            </p>
            <table class="api">
                <tr>
                    <td class="field">
                    ...
                    <td >
                        <input type = "text" name = "amount" maxlength = '20' value = "1000"><font color="red">*订单金额，以分为单位</font>
                    </td>
                </tr>
                <tr>
                    <td class="field">
                    ...
                    <td >
                      <select name="bankAbbr">
								        ...
								        <option value="CPSRB">中国邮政储蓄</option>
							       </select>
                    </td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td >
                        <input type = "text" name = "orderDate" value ="<%=currDate%>"> <font color="red">*商户发起请求的时间; 年年年年月月日日</font>
                ...
                <tr>
                    ...
                    <td >
                        <input type = "text" name = "orderId" value = "<%=currDate&Int(Timer())%>"> <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                    <td class="field">
                 ...
                 <tr>
                    ...
                    <td >
                        <input type = "text" name = "period" value = "7">   <font color="red">*数字</font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td >
                        <input type = "text" name = "productName" value = "测试商品01">  <font color="red">*</font>
                    </td>
                </tr>
                 <tr>
                    <td class="field">
                ...
                <tr>
                    ...
                    <td >
                        <input type = "text" name = "userToken" value = "15116410263"><font color="red">*</font>
                    </td>
                </tr>
                <tr>
                    <td class="field">
