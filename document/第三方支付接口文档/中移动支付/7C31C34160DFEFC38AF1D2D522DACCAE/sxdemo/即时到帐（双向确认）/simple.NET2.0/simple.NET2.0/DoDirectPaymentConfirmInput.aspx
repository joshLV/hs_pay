<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoDirectPaymentConfirmInput.aspx.cs" Inherits="MCGASPDOTNET.DoDirectPaymentConfirmInput" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>即时到帐（双向确认）</title>
...
<body>
    <form id="Form2" runat="server" >
        <br />
        <center>
            <span class="title"><b>即时到帐（双向确认）</b> </span>
            <br />
            <br />
            <table class="api">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="bankAbbr" runat="server">
                            ...
                            <asp:ListItem Value="CITIC">中信银行</asp:ListItem>
                            <asp:ListItem Value="HXB">华夏银行</asp:ListItem>
                            <asp:ListItem Value="FIB">兴业银行</asp:ListItem>
                            <asp:ListItem Value="CPSRB">中国邮政储蓄</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
