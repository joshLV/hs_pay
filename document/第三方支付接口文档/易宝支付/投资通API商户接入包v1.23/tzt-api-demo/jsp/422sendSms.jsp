...
<%
	...
	Map<String, String> result	= TZTService.sendSmsByOrder(orderid);
	...
	String sendtime   			= formatString(result.get("sendtime"));
	...
	if(!"".equals(error_code)) {
		...
		out.println("error_msg : " + error_msg + "<br><br>");
...
<title>4.2.2 发送短信验证码接口结果</title>
	...
	<body>
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" 
			...
			<tr>
				<td width="25%" align="left">&nbsp;短信发送时间</td>
				<td width="5%"  align="center"> : </td> 
				<td width="50%" align="left"> <%=sendtime%> </td>
				<td width="5%"  align="center"> - </td> 
				<td width="15%" align="left">sendtime</td> 
			</tr>
