 ...
 */
public class LianLianRechargeUtils {
    static LianLianRechargeUtils instance = null;

    /**
     * 生成连连支付工具类单例对象并进行返回
     * @return LianLianRechargeUtils 连连支付工具类
     */
    public static LianLianRechargeUtils getInstance(){
        if(instance == null){
            instance = new LianLianRechargeUtils();
        }
        return instance;
    }
