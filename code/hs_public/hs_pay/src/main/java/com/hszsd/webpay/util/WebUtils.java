...
import com.hszsd.webpay.common.SubmitMethod;
...
public class WebUtils {
	...
	public static String generateAutoSubmitForm(String url, Map<String, String> paramMap){
		return generateAutoSubmitForm(url, paramMap, SubmitMethod.POST);
	}
	 ...
	 * @return
	 */
	public static String generateAutoSubmitForm(String url, Map<String, String> paramMap, SubmitMethod method){
	 ...
	 * @return
	 */
	public static String generateStr(Map<String, String> map, String[] model, String ch, String connector){
	 ...
	 * @return
	 */
	public static String generateStr(Map<String, String> map, String[] model, String connector){
		if(map==null || map.size()<=0 || model==null || model.length<=0) return "";
		StringBuffer sb = new StringBuffer();
		for(int i=0;i<model.length;i++){
			Object value = map.get(model[i]);
