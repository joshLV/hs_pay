 ...
 * http请求获取用户基本信息实体
 */
public class HttpGetUserInfoDTO implements Serializable {
...
*/
	...
	public String toString() {
		return "HttpGetUserInfoDTO [userId=" + userId + ", username="
				+ username + ", useCredit=" + useCredit + ", useMoney="
				+ useMoney + ", realName=" + realName + ", sex=" + sex
				+ ", vipLevel=" + vipLevel + ", nation=" + nation + ", email="
				+ email + ", phone=" + phone + ", birthday=" + birthday
				+ ", address=" + address + ", typeId=" + typeId + ", islock="
				+ islock + ", status=" + status + ", realStatus=" + realStatus
				+ ", emailStatus=" + emailStatus + ", phoneStatus="
				+ phoneStatus + ", videoStatus=" + videoStatus
				+ ", sceneStatus=" + sceneStatus + ", avatar=" + avatar
