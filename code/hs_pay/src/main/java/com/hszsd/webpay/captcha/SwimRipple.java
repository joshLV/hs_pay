package com.hszsd.webpay.captcha;
...
/**
 * Created by gzhengdu on 2016/8/18.
 */
public class SwimRipple  extends Configurable implements GimpyEngine {
    /**
     * Applies distortion by adding swim ripple effect.
     *
    ...
    public BufferedImage getDistortedImage(BufferedImage baseImage)
    {
        ...
        swimFilter.setScale(40f);
        swimFilter.setTurbulence(1.5f);
        swimFilter.setAmount(5f);
        swimFilter.setStretch(2f);
        swimFilter.setTime(1.5f);
        effectImage = swimFilter.filter(effectImage, null);
